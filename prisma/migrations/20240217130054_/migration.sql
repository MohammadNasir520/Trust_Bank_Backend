...
CREATE TABLE "providers" (
    ...
    CONSTRAINT "providers_pkey" PRIMARY KEY ("providerAccount")
);
...
CREATE TABLE "paybills" (
    ...
    CONSTRAINT "paybills_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "providers_providerAccount_key" ON "providers"("providerAccount");
