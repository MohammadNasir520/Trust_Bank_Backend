...
const findLastAccountId = async () => {
    var _a, _b;
    const lastAccount = await prisma_1.default.currentAccount.findMany({
        orderBy: {
            createdAt: 'desc',
        },
    });
    console.log((_a = lastAccount[0]) === null || _a === void 0 ? void 0 : _a.accountId);
    return ((_b = lastAccount[0]) === null || _b === void 0 ? void 0 : _b.accountId) || 'St-00001';
};
...
const createNewIdNumber = async (accountType) => {
    ...
    const newAccountTd = splitAccountType[0] + splitAccountType[1] + '-' + incrementId;
